...
### Source: https://github.com/mskcc/odin-tmb/blob/master/compute-tmb.py
...
def main():
    ...
    parser.add_argument("--assayDb_file",     required=False,dest = 'assayDb_file', default = default_assay_db_path, help="assayDb_file")
